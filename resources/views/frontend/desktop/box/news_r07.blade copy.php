...
<div class="box1 box_white1">
    <div id="category_news_box" >
        ...
        <a title="المزيد في مستجدات التعليم" href="{{Common::mobileLink()}}education"><h3 class="box_title_two title_two">مستجدات التعليم</h3></a>
        </div>
        <div id="latest_news_two" class="box_two box_white_two">
            <ul>
                ...
                <?php foreach($newsR07 as $index=>$article) { ?>
                <div class="short_two">
