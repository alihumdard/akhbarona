<div class="box1 box_white1">
	<vte:box module="box_article_list">
		<vte:params>
			<vte:param name="search_cid" value="23" />
		...
		<vte:template>
			<div id="category_news_box" >
                ...
                <h3 class="box_title_wem title_wem">ركن المرأة</h3>
				</div>
									...
									<vte:if test="{article.image}">
										<div class="image">
											<a href="{article.get_href}">
												...
												<img src="{VIVVO_BANGTD_STATIC_IMG}{article.get_bangtd_summary_large}" width="140" height="100" alt="{image_caption}" /><br />
											</a>
										</div>
									</vte:if>
								<div class="clearer"> </div>
