<div class="box1 box_white1">
    <div id="category_news_box" >
        ...
        <a href="{{Config::get("app.url")}}sport/lionatlas"><h3 class="box_"><img width="650" src="{{$fileRepo->getDesktopUrl("img/news_r04.png")}}" alt="المزيد في أسود الأطلس" title="المزيد في أسود الأطلس"/></h3></a>
        </div>
        <div id="latest_news_two" class="box_sport box_white_sport">
            @if(count($newsSportR04) > 0)
                <ul>
                    <?php $article = $newsSportR04[0];unset($newsSportR04[0]);?>
                    ...
                    @foreach($newsSportR04 as $article)
                    ...
                    @endforeach
                    <div class="more_sw"><a class="more_sw" href="{{Config::get("app.url")}}sport/lionatlas"></a></div>
                    <div class="clearer"> </div>
                </ul>
            @endif
        </div>
