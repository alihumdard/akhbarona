<div class="box1 box_white1">
    <div id="category_news_box" >
        ...
        <a href="{{Config::get("app.url")}}sport/footmarocain"><h3 class="box_"><img width="650" src="{{$fileRepo->getDesktopUrl("img/news_r02.png")}}" alt="المزيد في كورة مغربية" title="المزيد في كورة مغربية"/></h3></a>
        </div>
        <div id="latest_news_two" class="box_sport box_white_sport">
            @if(count($newsSportR02) > 0)
            <ul>
                <?php $article = $newsSportR02[0];unset($newsSportR02[0]);?>
                ...
                @foreach($newsSportR02 as $article)
                ...
                @endforeach
                <div class="more_sw"><a class="more_sw" href="{{Config::get("app.url")}}sport/footmarocain"></a></div>
                <div class="clearer"> </div>
            </ul>
            @endif
        </div>
