                ...
                <div id="box_center_holder">
                    @if($isContact)
                        <div class="box_white_pages">
                            @include("frontend.desktop.system.box_default.box_form",[$cdnUrl])
                        </div>
                    @else
...
@section("styles")
    <link media="all" type="text/css" rel="stylesheet" href="{{ url(Config::get('app.cdn_url_css').'themes/akhbarona210/css/category'.Config::get('app.css_extend').'.css') }}">
        <link media="all" type="text/css" rel="stylesheet" href="{{ url(Config::get('app.cdn_url_css').'themes/akhbarona210/css/plugin_form_builder.css') }}">
@stop
