    ...
    <div class="comment_holder">
        ...
        <div class="comment_body">
            ...
            <div class="comment_actions">
                <a href="javascript:voteComment({{$comment->id}}, 1);"><img src="{{$fileRepo->getMobileUrl("img/thumbs_upx.gif")}}" title="{{Config::get("site.lang.LNG_COMMENTS_THUMB_UP")}}" alt="{{Config::get("site.lang.LNG_COMMENTS_THUMB_UP")}}" /></a>
                <a href="javascript:voteComment({{$comment->id}}, -1);"><img src="{{$fileRepo->getMobileUrl("img/thumbs_downx.gif")}}" title="{{Config::get("site.lang.LNG_COMMENTS_THUMB_DOWN")}}" alt="{{Config::get("site.lang.LNG_COMMENTS_THUMB_DOWN")}}" /></a>
