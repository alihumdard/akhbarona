<div id="box_social_bookmarks">
	...
	<div class="cmnt_bar">
        ...
        <a href="whatsapp://send?text={!!  urlencode(Common::article_link($article))!!}"><img src="{{$fileRepo->getMobileUrl('img/whatsapp-share-button.png')}}" title="Whatsapp share" style="width: auto !important; height: 20px !important;margin-top: -13px;padding-right: 20px;" /></a>
	</div>
</div>
