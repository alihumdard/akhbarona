<div class="avatar-wrapper">
    ...
    <div class="text-center">
        <div class="avatar-preview">
            <img class="avatar8 rounded-circle img-thumbnail img-responsive mt-5 mb-4"
                 width="150"
                 src="{{ $edit ? $user->present()->avatar : url('admin/assets/img/profile.png') }}">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4 avatar-source" id="no-photo"
                         data-url="{{ $updateUrl }}">
                        <img src="{{ url('admin/assets/img/profile.png') }}" class="rounded-circle img-thumbnail img-responsive">
