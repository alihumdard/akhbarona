(function() {
	...
	window.Media = {
		init : function() {
			...
			editor.dom.setOuterHTML(get('media_type'),
		...
		insert : function() {
			...
			this.data.videojs        = getVal('enabled_videojs');
			this.data.videoads       = getVal('enabled_ads');
			this.data.fluid          = getVal('enabled_fluid');
			this.data.videoautoplay  = getVal('enabled_autoplay');
			if(this.data.type=='video'){
				this.data.video.attrs['data-videojs']       = getVal('enabled_videojs');
				this.data.video.attrs['data-videoads']      = getVal('enabled_ads');
				this.data.video.attrs['data-fluid']         = getVal('enabled_fluid');
				this.data.video.attrs['data-videoautoplay'] = getVal('enabled_autoplay');
			}
			this.data.params['data-videojs']       = getVal('enabled_videojs');
			this.data.params['data-videoads']      = getVal('enabled_ads');
			this.data.params['data-fluid']         = getVal('enabled_fluid');
			this.data.params['data-videoautoplay'] = getVal('enabled_autoplay');
		...
		dataToForm : function() {
			...
			if(this.data.type=='video'){
				...
				if(typeof(this.data.video.attrs['data-videojs']) != "undefined" && this.data.video.attrs['data-videojs'] !== null){
					
				setVal('enabled_videojs',this.data.video.attrs['data-videojs']);
				setVal('enabled_fluid',this.data.video.attrs['data-fluid']);
				setVal('enabled_autoplay',this.data.video.attrs['data-videoautoplay']);
				setVal('enabled_ads',this.data.video.attrs['data-videoads']);
				
				}else{
					
				setVal('enabled_videojs',this.data.videojs);
				setVal('enabled_fluid',this.data.fluid);
				setVal('enabled_autoplay',this.data.videoautoplay);
				setVal('enabled_ads',this.data.videoads);
			...
			setVal('enabled_videojs',this.data.params['data-videojs']);	
			setVal('enabled_fluid',this.data.params['data-fluid']);	
			setVal('enabled_autoplay',this.data.params['data-videoautoplay']);	
			setVal('enabled_ads',this.data.params['data-videoads']);	
