	...
	window.Media = {
		...
		moveStates : function(to_form, field) {
			...
			function setOptions(type, names) {
                ...
                data.fluid         = getVal('enabled_fluid');
                data.videojs       = getVal('enabled_videojs');
                data.videoads      = getVal('enabled_ads');
                data.videoautoplay = getVal('enabled_autoplay');
				/****************************/
		...
		formToData : function(field) {
            ...
            if(field=='enabled_fluid')
				this.changeFluid(field);
			if (field == 'source') {
        ...
        changeFluid:function(field){
			setVal('data-fluid', getVal(field));
		},
