...
CalendarDateSelect.prototype = {
  initialize: function(target_element, options) {
    ...
    this.overwrite_date_format = this.options.get('overwrite_format');
    this.parseDate();
  ...
  dateString: function() {
    return (this.selection_made) ? this.selected_date.toFormattedString(this.use_time, this.overwrite_date_format) : "&#160;";
  },
  parseDate: function()
  {
